...
namespace Vision.Cms.Mvc.Api.Domain.StaffDirectory
{
    /// <summary>
    ...
    [ApiDataStructure]
    [ContentAPIName(ContentAPINameAttribute.StaffDirectory)]
    public class StaffContent : IContent
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="StaffContent"/> is display.
        /// </summary>
        /// <value>
